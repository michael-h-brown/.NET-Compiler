...
namespace CompilerNet.Tokens
{
    class If: Token
    {
        public static string structure = "^if (" + Operation.structure + "|" + Identifier.structure + "|" + String.structure + "|" + Int.structure + ") (is less than|is less than or equal to|is equal to|is greater than or equal to|is greater than) (" + Operation.structure + "|" + Identifier.structure + "|" + String.structure + "|" + Int.structure + "),$";
        public Token parameterOne;
        public Token parameterTwo;
        public string comparator;
        public If(Token ParameterOne, string Comparator, Token ParameterTwo)
        {
        ...
        {
            string output = prefixStringWithTab("if (" + parameterOne.translate(indentIndex) + " " + comparator + " " + parameterTwo.translate(indentIndex) + ") {\n", indentIndex);
        ...
        public static If checkToken(string input)
        {
            ...
            } else
            {
                ...
                return new If(testParam1, testComp, testParam2);
            }
        }
    }
}
